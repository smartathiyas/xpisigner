...
public class ASN1
{
    ...
    public static final byte SETOF =0x31;
    ...
    public static final byte[] OIDsRSAEncryption = new byte[]{0x2A, (byte) 0x86, 0x48, (byte) 0x86, (byte) 0xF7, 0x0D, 0x01, 0x01, 0x01};//   - SHA-1
    ...
    public static final byte[] OIDsSignedData = new byte[]{(byte) 0x2A, (byte) 0x86, (byte) 0x48, (byte) 0x86, (byte) 0xF7, (byte) 0x0D, (byte) 0x01, (byte) 0x07, (byte) 0x02};
    ...
    public static final byte[] OIDsContentType = new byte[]{0x2A, (byte) 0x86, 0x48, (byte) 0x86, (byte) 0xF7, 0x0D, 0x01, 0x09, 0x03};
    public static final byte[] OIDsMessageDigest = new byte[]{0x2A, (byte) 0x86, 0x48, (byte) 0x86, (byte) 0xF7, 0x0D, 0x01, 0x09, 0x04};
    public static final byte[] OIDsSigningTime = new byte[]{0x2A, (byte) 0x86, 0x48, (byte) 0x86, (byte) 0xF7, 0x0D, 0x01, 0x09, 0x05};
    ...
    public static boolean[] toBooleans(byte[] bytes, int numUnusedBits)
    {
        if (numUnusedBits < 0 || numUnusedBits > 7)
        {
            throw new java.lang.IllegalArgumentException("Utils::BytesToBooleans - number "
                                                         + "of unused bits in last byte must me in the range 0-7, " + "we have " + numUnusedBits);
        }
        if (bytes == null)
        {
