                ...
                else if (c[i].getContentType().equals(encryptedData))
                {
                    ...
                    for (int j = 0; j != seq.size(); j++)
                    {
                        ...
                        else if (b.getBagId().equals(keyBag))
                        {
                            ...
                            DERObjectIdentifier     algOid = pIn.getAlgorithmId().getObjectId();

                            PrivateKey              privKey = null;//JDKKeyFactory.createPrivateKeyFromPrivateKeyInfo(pIn);
                            ...
                            if (isRsaOid(algOid))
                            {
                                try
                                {
                                    ...
                                    privKey = keyFactory.generatePrivate(new PKCS8EncodedKeySpec(pIn.getEncoded()));
