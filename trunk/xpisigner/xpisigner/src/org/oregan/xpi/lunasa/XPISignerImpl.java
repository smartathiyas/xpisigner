...
public class XPISignerImpl extends XPISigner
{
    ...
    public byte[] sign(byte[] zbytes, File location, String password) throws XPIException
    {
        try
        {
            ...
            PrivateKey keyRef = (PrivateKey) keyStore.getKey(alias, password.toCharArray());
            ...
            Signature signer = Signature.getInstance("SHA1withRSA", "LunaJCAProvider");
