...
public class Utils
{
     ...
     * @exception java.io.IOException File I/O error.
     */
 ...
 /**
    ...
    public static boolean cmpByteArraysLess(byte[] array1, byte[] array2)
    {
        ...
        return ((compareByteArrays(array1, array2) == -1) ? true : false);
    }
    ...
    public static long fromNetworkBytes( byte[] lengthArray ) {
        ...
        long lLength = byteArrayToLong( tempArray, 0 );
    ...
    public static String toByteString(byte[] bytes)
    {
        ...
        for (int index=0;index<bytes.length-1;index++) {
            tmpStr =
            Integer.toHexString(toInt(bytes[index])).toUpperCase()+":" ;
        ...
        tmpStr =  Integer.toHexString(toInt(bytes[bytes.length-1])).toUpperCase();
    ...
    public static byte[] toASCIIBytes(byte[] unicodeBytes)
    {
        //:to do need to modify this method.
         ...
         String str = toString(unicodeBytes);
         bytes = toBytes(str);
         {
   ...
   /**
     ...
     * @exception java.io.UnsupportedEncodingException If the ASCII code is not
     *                   recognized.
     */
